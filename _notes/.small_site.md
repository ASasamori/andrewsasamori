...
My research interests sit at the intersection of chain-of-thought reasoning, AI evaluation and benchmarking, and model optimization for computational efficiency. A notes section gives me room to write down experiments and reading notes without turning the home page into a résumé.
...
Future notes can be added as individual `.md` files in `_notes/`. The front matter supplies ordering and optional metadata, while everything below becomes the article.
